    ...
    public static void main(String[] args){
        ...
        */
        ...
        try
        {
            ...
            DatabaseSupplier.addSupplier(new Supplier("gilang", "gilang1@mail.com", "+628889888888", location1));
            DatabaseSupplier.addSupplier(new Supplier("gilang", "gilang2@mail.com", "+6288898888", location1));
        }
        ...
        try
        {
            DatabaseSupplier.removeSupplier(1);
        }
        ...
        try
        {
            DatabaseItem.addItem(new Item ("meja",ItemStatus.New ,1,DatabaseSupplier.getSupplier(2), ItemCategory.Electronics ));
            DatabaseItem.addItem(new Item ("meja",ItemStatus.New ,1,DatabaseSupplier.getSupplier(2), ItemCategory.Electronics ));
        }
